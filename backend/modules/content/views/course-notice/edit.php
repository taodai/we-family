            ...
            <table class="m-table" style="width: 95%">
                ...
                <tr><th>首页大图：</th>
                    <td>
                        ...
                        <span style="padding-left:24px;">图片比例为2：1（建议大小640X320）</span>
                    </td>
                </tr>
                ...
                <tr><th>概述：</th><td> <input type="text" name="info" data-options="multiline:true" class="easyui-textbox" style="width:325px;height:90px" value="<?php echo $wiki['info'] ?>"></td></tr>
                <tr><th>内容：</th>
                    <td>
                        <?php
...
<script>
    var Yii = {
        ...
        'upload': '<?php echo Url::toRoute('lecturer/upload')?>',
