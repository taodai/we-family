    ...
    <div id="dlg" class="easyui-dialog singleColumn" style="width:600px;height:500px"
        ...
        <form id="fm" method="post" novalidate>
            <dl>
                ...
                <dd>
                    <input id="key"  name="key" class="textbox" data-options="multiple:true,multiline:true" style="width:200px;" />
                </dd>
...
<script>
    var Yii = {
        'add' : '<?php echo Url::toRoute('handle/keys-add') ?>',
        'list': '<?php echo Url::toRoute('handle/keys-list') ?>',
        'edit': '<?php echo Url::toRoute('handle/keys-edit') ?>',
    };
    var url;
    $(function(){
        $('#dg').datagrid({
