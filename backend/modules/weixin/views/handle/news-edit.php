...
<div  class="easyui-panel" title="修改图文">
        <form id="fm" method="post" novalidate>
            <dl>
                ...
                <dd>
                    <input type="hidden" id="picUrl" name="picUrl" value="<?php echo $news->picUrl; ?>">
                    <input type="hidden" id="id"  value="<?php echo $news->id; ?>">
                    <input type="hidden" id="picName" name="picName" value="<?php echo $news->picName; ?>">
                    ...
                    <img  width="360" height="200"  id="pic" src="<?php echo $news->picUrl; ?>"/>
                ...
                <dd>
                    <textarea id="description" name="description" class="easyui-validatebox input_text" style="width:500px;height:100px" editable="false"  ><?php echo $news->description; ?></textarea>
                </dd>
    ...
    function save()
    {
        ...
        $("#content").val(content);
        var id=$("#id").val();
        var url = "/weixin/handle/news-edit?id="+id;
        $('#fm').form('submit',
            {  
            url: url,  
